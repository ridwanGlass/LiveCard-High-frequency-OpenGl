...
public class Cube {
	...
	/** Vertex colors. */
	private static final float COLORS[] = { 0.0f, 1.0f, 1.0f, 1.0f, 1.0f, 0.0f,
			0.0f, 1.0f, 1.0f, 1.0f, 0.0f, 1.0f, 0.0f, 1.0f, 0.0f, 1.0f, 0.0f,
			0.0f, 1.0f, 1.0f, 1.0f, 0.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f, 1.0f,
			0.0f, 1.0f, 1.0f, 1.0f, };

	/** Order to draw vertices as triangles. */
	private static final byte INDICES[] = { 0, 1, 3, 3, 1, 2, // Front face.
	...
	private static final String VERTEX_SHADER_CODE = "uniform mat4 uMVPMatrix;"
			...
			+ "varying vec4 _vColor;" + "void main() {" + "  _vColor = vColor;"
	...
	public void draw(float[] mvpMatrix) {
		...
		GLES20.glVertexAttribPointer(mPositionHandle, 3, GLES20.GL_FLOAT,
				false, VERTEX_STRIDE, mVertexBuffer);
